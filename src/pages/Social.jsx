    ...
    return (
        <Flex padding="3" direction="column">
            ...
            >
                ...
                <Text>
                    Congraulations @LulaOfficial, on your election as President
                    of Brazil. I look forward to working with you ot adress
                    pressing global challenges, from food security to trade and
                    climate change.
                </Text>
            </Box>
        </Flex>
