    ...
    <Flex direction="column" gap="5">
      ...
      >
        ...
        <Text
          ...
          color="#464646;"
        >
          you can vote <b>online</b> or <b>stationary</b> at electoral district
        </Text>
      </Box>
      ...
      >
        ...
        <Box background="#183E7A" borderRadius="lg" color="#FFFFFF" align='center' padding="2">
          <Text fontSize="12px" as='b'>Change your voting place</Text>
          <Text fontSize="10px">for stationary voting</Text>
        </Box>
      </Box>

      <Box background="#FFFFFF" border="2px" borderColor="#193769;" borderRadius="2xl" boxShadow="lg" padding="5" align='center'>
        
        <Text color="#193769;" >
          You don’t know who to vote for?
        </Text>
        <Text color="#193769;" as='b' >
          Take a quiz!
        </Text>
        <Box background="#183E7A" borderRadius="lg" color="#FFFFFF" padding="2">
          <Text fontSize="24px" as='b'>QUIZ</Text>
        </Box>
      </Box>
    </Flex>
  );
